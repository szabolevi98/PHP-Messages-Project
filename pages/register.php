...
?>
<form class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?page=register" method="post">
	...
	<p class="mb-0">Már van felhasználói fiókod? <a href="index.php?page=login">Jelentkezz be</a>.</p>
</form>
