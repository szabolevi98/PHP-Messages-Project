...
?>
<form class="form-signin" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>?page=send-message" method="post">
    ...
    <p class="mb-0"><a href="index.php?page=home">Vissza</a></p>
</form>
